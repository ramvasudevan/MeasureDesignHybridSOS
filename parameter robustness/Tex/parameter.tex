...
\begin{flalign}
	\sup \ip{\mu_0,1}\\
	&&\begin{split}
	\int_{\mathcal X_T\times \Theta}v(T,x,\theta)\,d \mu_{T}+&\,\int_{\mathcal T\times \mathcal G}v(t,x,\theta)\,d\mu^{G}(t,x,\theta)=\int_{\mathcal X\times \Theta}v(0,x,\theta)\,d\mu_0\otimes\mu_\theta\\
	...
	&& \int_{\mathcal X}w(x)\,d\mu_0+\int_{\mathcal X}w(x)\,d\hat\mu_0=&\,\int_{\mathcal X}w(x)\,d\lambda\\
	&& \int_{\mathcal X_T\times \Theta} 1\,d\mu_T=&\,\int_{\mathcal X}1\,d\mu_0
\end{flalign}
where $$\mathcal G=\{(x,\theta)\mid g(x,\theta)=0,\,\forall \theta\in \Theta,\,x\in \mathcal X\}$$
